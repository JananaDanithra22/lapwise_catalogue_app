...
import '../widgets/menubar.dart'; // <-- Make sure this file contains CustomMenuBar
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        // Removed the manual leading icon to enable default hamburger
      ),
      drawer: const CustomMenuBar(), // <-- Drawer added here
      body: Padding(
